...
COMMON=" -demo -data_label multilabel -epoch 140 -per 100 -label_class 6 -K 7 -cluster 0 -sample_gap 90 -draw_plt 0 -ES_pat 100 -wandb -wandb_project TEEDAM_debug_garbage "
...
do
    SETTING=" -data  $PRE/$DATA_NAME/ -split $i_split --te_d_mark 16 --dam_output_dims 32" 
        ...
        echo "TEE+DAM (MLplus)"            
        python Main.py  -seed 8223 $ENCODER_M1 $HPs $COEFS $SETTING $COMMON $TEDA__pp_ml_plus -user_prefix "THP(128)-SeFT(16)" -time_enc concat -wandb_tag RD75 > logs/Supervised/debug.log 2>&1
