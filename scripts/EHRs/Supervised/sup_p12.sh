...
HPs="-batch_size 4  -lr 0.001 -weight_decay 0.1 -w_pos_label 0.5 1.5"
...
do
    SETTING=" -data  $PRE/$DATA_NAME/ -split $i_split --te_d_mark 16 --dam_output_dims 32" 
        ...
        echo "TEE+DAM (MLplus)"            
        python Main.py  -seed 88888 $ENCODER_M1 $HPs $COEFS $SETTING $COMMON $TEDA__pp_ml_plus -user_prefix "AttNHP(256)/mTAN(64)" -time_enc concat -wandb_tag RD75 > logs/Supervised/debug_pda.log 2>&1
